...
const DEFAULT_FAQ = [
  ...
  { question: 'What premium brands do you use?', answer: 'We use Häfele and Hettich for hardware, Merino and Greenlam for laminates, and CenturyPly and Greenply for plywood — all top-tier brands.' },
